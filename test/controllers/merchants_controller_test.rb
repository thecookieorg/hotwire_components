...
class MerchantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create merchant" do
    assert_difference('Merchant.count') do
      post merchants_url, params: { merchant: { about: @merchant.about, name: @merchant.name, phone: @merchant.phone } }
    end
  ...
  test "should update merchant" do
    patch merchant_url(@merchant), params: { merchant: { about: @merchant.about, name: @merchant.name, phone: @merchant.phone } }
